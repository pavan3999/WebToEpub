...
class EpubMetaInfo {
    ...
    static getDefaultStyleSheet() {
        ...
        // Visible Table of Contents generated by WebToEpub.
        ".webToEpub-information-toc {\r" +
        "   margin-top: 2em;\r" +
        "   padding-top: 1em;\r" +
        "}\r" +
        ".webToEpub-information-toc h2 {\r" +
        "   margin-top: 0;\r" +
        "   margin-bottom: 1em;\r" +
        "}\r" +
        ".webToEpub-information-toc ol {\r" +
        "   margin: 0;\r" +
        "   padding-left: 2em;\r" +
        "}\r" +
        ".webToEpub-information-toc li {\r" +
        "   margin: 0.35em 0;\r" +
        "   padding: 0;\r" +
        "   line-height: 1.5;\r" +
        "}\r" +
        ".webToEpub-information-toc-link {\r" +
        "   text-decoration: none;\r" +
        "}\r" +
        ".webToEpub-information-toc-link:visited {\r" +
        "   text-decoration: none;\r" +
        "}\r" +
